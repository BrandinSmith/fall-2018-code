// Note: code came from: http://www.ntu.edu.sg/home/ehchua/programming/java/j5e_multithreading.html
// Nice resource... check it! 
...
public class MoreResponsiveUI extends JFrame {
   private boolean stop = false;
   private JTextField tfCount;
   private int count = 1;
 
   /** Constructor to setup the GUI components */
   public MoreResponsiveUI() {
   ...
   public static void main(String[] args) {
      ...
      javax.swing.SwingUtilities.invokeLater(new Runnable() {
         @Override
         public void run() {
            new MoreResponsiveUI();  // Let the constructor do the job
         }
      });
   }
}